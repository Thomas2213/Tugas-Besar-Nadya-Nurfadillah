...
<body class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="index.php.html">Home</a></li>
    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-image: url(in.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">WEBSITE FILM TERBAIK</h1>
                                    <div class="animation animated-item-2">
                                        Every People Have Their Favorites Film
	...
	<section class="main-section paddind" id="Portfolio">
		...
		<div class="portfolioContainer wow fadeInUp delay-04s">
			<div class=" Portfolio-box printdesign">
				<a href="to.jpg"><img src="to.jpg" alt=""></a>
				<center><h3>How To Train Your Dragon!</h3></center>
				<br><br>
			</div>
			<div class="Portfolio-box webdesign">
				<a href="shaz.jpg"><img src="shaz.jpg" alt=""></a>
				<center><h3>Shazam!</h3></center>
			</div>
			<br><br>
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; 2018-Forever <a target="_blank" href="http://shapebootstrap.net/" title="Free Twitter Bootstrap WordPress Themes and HTML templates">Thomas Nady</a>. All Rights Reserved.
                </div>
                <div class="col-sm-6">
